    ...
    <>
      <div className={classes.container}>
        ...
        <div className={classes.add_form_container}>
          <AddForm
            type="toilet"
            changeLocationTo="/park-and-castle/select-location"
...
export default AddParkAndCastle;
